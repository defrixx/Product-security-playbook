...
- SPA взаимодействует с BFF через защищенную session на основе cookie
...
- Именованный owner (команда + ответственное лицо)
- Tracking ticket
- Явное бизнес-обоснование
...
- Истекшие исключения блокируют релиз до продления с одобрением security или удаления.
