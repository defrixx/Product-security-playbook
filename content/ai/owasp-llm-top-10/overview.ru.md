...
### Кратко (OWASP)
Недостаточная валидация и санитизация output LLM до передачи downstream-системам, из-за чего ответы модели становятся вектором инъекций и исполнения вредоносного кода.
