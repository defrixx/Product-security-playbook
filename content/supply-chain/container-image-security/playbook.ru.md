# Плейбук безопасности образов контейнеров и OCI-реестра
...
Вне области:
- общая база SAST, SCA и поиска секретов для исходного кода и зависимостей: используйте [плейбук безопасной разработки и ревью кода](../../application-security/secure-coding/code-review/playbook.ru.md); этот документ определяет только специфику сканирования собранных образов, их слоев и OCI-артефактов;
