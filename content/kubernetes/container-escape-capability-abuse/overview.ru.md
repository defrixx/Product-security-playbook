...
Атака успешна, когда один или несколько этих контролей неправильно настроены, их удалось обойти, контроли избыточно разрешительны или сломаны из-за уязвимости ядра/runtime.
