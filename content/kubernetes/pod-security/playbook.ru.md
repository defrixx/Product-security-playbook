...
- Повторное использование избыточно разрешительных default identities
...
- Требуйте объекты исключений с owner/expiry для любого обхода policy.
...
Каждый anti-pattern напрямую увеличивает риск из threat model:
