...
## 7. Exception Governance (Mandatory)

Any exception to TTL/renewal/revocation/rotation controls must include:
...
- Closure criteria
Expired exceptions block production rollout until renewed with security approval or removed.