# Secure AI-Assisted Development Playbook
...
- General code quality and security requirements are in the [Secure Coding and Code Review playbook](../../application-security/secure-coding/code-review/playbook.en.md).
- Autonomy, tool authorization, memory, sandboxing, approval, rollback, and kill-switch controls are in the [Agentic AI Security playbook](../agentic-ai/playbook.en.md).
- MCP server registry and protocol controls are in the [MCP Security playbook](../mcp-security/playbook.en.md).

Out of scope:
- developing or training foundation models;
- selecting controls for AI features running inside a product; use the [Securing AI overview](../securing-ai/overview.en.md);
...
- Use the [Secure Coding and Code Review playbook](../../application-security/secure-coding/code-review/playbook.en.md) for language- and framework-specific review.
...
- Apply the generic SCA and secret-scanning baseline from the [Secure Coding and Code Review playbook](../../application-security/secure-coding/code-review/playbook.en.md). For AI-generated dependency changes, additionally verify package reputation, transitive dependencies, and lifecycle/install scripts for high-impact packages.
...
- Run SAST, SCA, and secret scanning under the generic baseline in the [Secure Coding and Code Review playbook](../../application-security/secure-coding/code-review/playbook.en.md). For AI-generated changes, this playbook adds independent verification of generated tests and applicable domain scanners and targeted security tests for IaC, containers, and exposed paths.
...
`Baseline`:
- Coding agents with shell, browser, file-write, or package-install capabilities also comply with the [Agentic AI Security playbook](../agentic-ai/playbook.en.md).
