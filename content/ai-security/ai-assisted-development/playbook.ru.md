# Плейбук безопасной разработки с ИИ
...
- Общие требования к качеству и безопасности кода находятся в [плейбуке безопасной разработки и ревью кода](../../application-security/secure-coding/code-review/playbook.ru.md).
- Автономия, tool authorization, memory, sandbox, согласование, rollback и kill switch находятся в [плейбуке безопасности Agentic AI](../agentic-ai/playbook.ru.md).
- MCP server registry и меры контроля протокола находятся в [плейбуке безопасности MCP](../mcp-security/playbook.ru.md).

Вне области:
- разработка или обучение foundation models;
- выбор мер контроля для AI-функций, работающих внутри продукта; используйте [обзор безопасности AI](../securing-ai/overview.ru.md);
...
- Используйте [плейбук безопасной разработки и ревью кода](../../application-security/secure-coding/code-review/playbook.ru.md) для language/framework-specific проверки.
...
- Применяйте общую базу SCA и поиска секретов из [плейбука безопасной разработки и ревью кода](../../application-security/secure-coding/code-review/playbook.ru.md). Для изменений зависимостей, сгенерированных ИИ, дополнительно проверяйте репутацию пакета, транзитивные зависимости и lifecycle/install scripts пакетов с высоким воздействием.
...
- Выполняйте SAST, SCA и поиск секретов по общей базе [плейбука безопасной разработки и ревью кода](../../application-security/secure-coding/code-review/playbook.ru.md). Для изменений, сгенерированных ИИ, этот плейбук добавляет независимую проверку сгенерированных тестов, а для IaC, контейнеров и доступных извне путей — применимые доменные сканеры и целевые тесты безопасности.
...
`Baseline`:
- Coding agents с shell, browser, file write или package installation дополнительно соответствуют [плейбуку безопасности Agentic AI](../agentic-ai/playbook.ru.md).
