# Плейбук защиты веб-приложений по OWASP Top 10
...
- Специфичные для браузера меры контроля для CSP, CORS, cookies, embedded content и frontend supply chain находятся в [плейбуке безопасности браузера и frontend-части](../browser-security/playbook.ru.md).
