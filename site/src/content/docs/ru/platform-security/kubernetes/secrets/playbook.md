---
title: "Плейбук безопасности Kubernetes Secrets"
description: "Этот плейбук описывает защиту встроенных Kubernetes-объектов `Secret` и путь доставки секретов в runtime для рабочих нагрузок."
sidebar:
  order: 40
---
## 1. Область и цель
