---
title: "Плейбук защиты от злоупотреблений бизнес-логикой"
...
- меры контроля сессий и токенов OAuth/OIDC: используйте [плейбук OIDC + OAuth 2.0](/Product-security-playbook/ru/application-security/identity/oidc-oauth/playbook/);
...
- проверка валидации, кодирования вывода, реализации аутентификации и сессий, защиты от инъекций, обработки файлов, журналирования и корректности криптографии на уровне кода: используйте [плейбук безопасной разработки и ревью кода](/Product-security-playbook/ru/application-security/secure-coding/code-review/playbook/).
...
Используйте этот плейбук вместе с [плейбуком безопасной разработки и ревью кода](/Product-security-playbook/ru/application-security/secure-coding/code-review/playbook/). Ревью кода проверяет корректность реализации защитных механизмов; проверка злоупотреблений бизнес-логикой — возможность нарушить инварианты продукта легитимными действиями. Для потоков продукта с высоким риском перед релизом нужны обе проверки.
